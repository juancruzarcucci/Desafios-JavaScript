...
productos.push({id:7, nombre: "Air Sneakers 7", precio: 110, stock: 15, demanda: 5, imagen: ` /img/foto-noticia-8`, info: `Se entregan en un plazo de 7 dias habiles. Vienen con caja y etiqueta original.`});
productos.push({id:8, nombre: "Air Sneakers 8", precio: 220, stock: 15, demanda: 5, imagen: ` /img/foto-noticia-9`, info: `Se entregan en un plazo de 7 dias habiles. Vienen con caja y etiqueta original.`});
productos.push({id:9, nombre: "Air Sneakers 9", precio: 250, stock: 15, demanda: 5, imagen: ` /img/foto-noticia-10`, info: `Se entregan en un plazo de 7 dias habiles. Vienen con caja y etiqueta original.`});
